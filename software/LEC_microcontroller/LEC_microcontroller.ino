...
*/
  ...
  if (x_float > 0.3 && x_float <= 0.75 && y_float <= 1.2 && y_float >= 0.8) {
    Serial.println("G0X-0.2F400");
    delay(dt_xy);
  }

  if (y_float >= 0.3 && y_float <= 0.75 && x_float <= 1.2 && x_float >= 0.8) {
    Serial.println("G0Y-0.2F400");
    delay(dt_xy);
  }
...
//    Serial.println("G0X0.05Y0.05F200");
//    delay(dt_xy);
//  }
//
//
...
//    Serial.println("G0X0.05Y-0.05F200");
//    delay(dt_xy);
//  }
//
//  if (x_float > 1.2 && y_float < 0.8) {
//    Serial.println("G0X-0.05Y0.05F200");
//    delay(dt_xy);
//  }
